...
ret, output1 = cv2.threshold(img_gray, 100, 255, cv2.THRESH_BINARY)     # 如果大於 127 就等於 255，反之等於 0。
ret, output2 = cv2.threshold(img_gray, 100, 255, cv2.THRESH_BINARY_INV) # 如果大於 127 就等於 0，反之等於 255。
